...
public class CreateHelper {
	...
	@Test
	public void test()  {
		String callCommand = "ember generate helper %s";
		Root root = new Root("create_helper", "创建助手(helper)","helper", callCommand, "IProject");
		
		PageControl pageControl1 = new PageControl("helper_title_label","Label","助手名称(helper):","SWT.NONE");
		PageControl pageControl1_1 = new PageControl("0","Text","请输入助手路径或名称(路径用'/')","SWT.BORDER");
...
//			FileWriter fileWriter = new FileWriter(new File("C:\\Users\\ThinkPad\\Desktop\\json.txt"));
			Writer fileWriter = new BufferedWriter(  
			        new OutputStreamWriter(  
			                new FileOutputStream(new File("C:\\Users\\ThinkPad\\Desktop\\开发向导\\配置文件\\创建助手.config")), "UTF-8")); 
