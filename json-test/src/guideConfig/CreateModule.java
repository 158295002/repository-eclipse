...
public class CreateModule {
	...
	@Test
	public void test()  {
		String callCommand = "ember generate in-repo-addon %s";
		Root root = new Root("create_module", "创建模块","module", callCommand, "IProject");
		
		PageControl pageControl1 = new PageControl("module_title_label","Label","模块名称:","SWT.NONE");
		PageControl pageControl2 = new PageControl("0","Text","模块名称要以' inno- '开头","SWT.BORDER");
...
//			FileWriter fileWriter = new FileWriter(new File("C:\\Users\\ThinkPad\\Desktop\\json.txt"));
			Writer fileWriter = new BufferedWriter(  
			        new OutputStreamWriter(  
			                new FileOutputStream(new File("C:\\Users\\ThinkPad\\Desktop\\开发向导\\配置文件\\创建模块.config")), "UTF-8")); 
