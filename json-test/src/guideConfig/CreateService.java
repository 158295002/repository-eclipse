...
public class CreateService {
	...
	@Test
	public void test()  {
		String callCommand = "ember generate service %s";
		Root root = new Root("create_service", "创建服务(service)","service", callCommand, "IProject");
		
		PageControl pageControl1 = new PageControl("service_title_label","Label","服务名称(service):","SWT.NONE");
		PageControl pageControl1_1 = new PageControl("0","Text","请输入服务路径或名称(路径用'/')","SWT.BORDER");
...
//			FileWriter fileWriter = new FileWriter(new File("C:\\Users\\ThinkPad\\Desktop\\json.txt"));
			Writer fileWriter = new BufferedWriter(  
			        new OutputStreamWriter(  
			                new FileOutputStream(new File("C:\\Users\\ThinkPad\\Desktop\\开发向导\\配置文件\\创建服务.config")), "UTF-8")); 
