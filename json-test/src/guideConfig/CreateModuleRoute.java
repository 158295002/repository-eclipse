...
public class CreateModuleRoute {

	
	@Test
	public void test()  {
		String callCommand = "ember generate route %s -ir %s";
		Root root = new Root("create_module_route", "创建模块路由","module_route", callCommand, "IProject");
		
		PageControl pageControl1 = new PageControl("module_route_title_label","Label","路由路径:","SWT.NONE");
		PageControl pageControl1_1 = new PageControl("0","Text","请输入路由路径或名称(路径用'/')","SWT.BORDER");
		PageControl pageControl2 = new PageControl("module_route_title_label","Label","模块名称:","SWT.NONE");
...
//			FileWriter fileWriter = new FileWriter(new File("C:\\Users\\ThinkPad\\Desktop\\json.txt"));
			Writer fileWriter = new BufferedWriter(  
			        new OutputStreamWriter(  
			                new FileOutputStream(new File("C:\\Users\\ThinkPad\\Desktop\\开发向导\\配置文件\\创建模块路由.config")), "UTF-8")); 
